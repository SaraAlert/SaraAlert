...
namespace :demo do
  ...
  def demo_populate_laboratories(data)
    ...
    patient_ids_lab = if data[:days_ago] > ADMIN_OPTIONS['asymp_non_test_based_recovery_period_days']
    ...
    patient_ids_lab.each_with_index do |patient_id, index|
      ...
      result = if data[:days_ago] > ADMIN_OPTIONS['asymp_non_test_based_recovery_period_days']
