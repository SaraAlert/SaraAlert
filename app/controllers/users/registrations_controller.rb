...
# Override the default Devise registrations controller: we want to allow users to change their password (it's
# required on first login) but not allow them to change their email address
