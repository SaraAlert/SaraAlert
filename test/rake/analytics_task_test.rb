...
class AnalyticsTaskTest < ActiveSupport::TestCase
  ...
  test "monitoree counts by exposure country" do
    ...
    verify_monitoree_count(overall_counts, 5, false, 'Exposure Country', 'Malaysia', 'High', 1)
    verify_monitoree_count(overall_counts, 6, false, 'Exposure Country', 'Malaysia', 'Low', 1)
    verify_monitoree_count(overall_counts, 7, false, 'Exposure Country', 'Malaysia', 'Medium', 1)
    verify_monitoree_count(overall_counts, 8, false, 'Exposure Country', 'Malaysia', 'Missing', 1)
  ...
  test "monitoree counts by last exposure date" do
    ...
    verify_monitoree_count(active_counts, 0, true, 'Last Exposure Date', days_ago(27), 'Medium', 1)
    verify_monitoree_count(active_counts, 1, true, 'Last Exposure Date', days_ago(27), 'Missing', 1)
    ...
    verify_monitoree_count(overall_counts, 0, false, 'Last Exposure Date', days_ago(27), 'Medium', 1)
    verify_monitoree_count(overall_counts, 1, false, 'Last Exposure Date', days_ago(27), 'Missing', 1)
