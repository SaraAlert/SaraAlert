...
describe('CloseContactModal', () => {
  ...
  it('Properly renders accurate count of characters remaining for notes field', () => {
    ...
    expect(emptyCCWrapper.find('.character-limit-text').at(0).text()).toContain('2000 characters remaining');
    emptyCCWrapper
      .find(Modal.Body)
      .find('Row')
      .at(3)
    ...
    expect(emptyCCWrapper.find('.character-limit-text').at(0).text()).toContain(`${2000 - testNoteString.length} characters remaining`);
  });
