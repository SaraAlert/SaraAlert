...
describe('HOH', () => {
  it('Properly renders all main components', () => {
    const wrapper = shallow(<HOH patient={mockPatient1} dependents={[ mockPatient2 ]} can_add_group={true} authenticity_token={authyToken} />);
    const wrapper2 = shallow(<HOH patient={mockPatient1} dependents={[ mockPatient2 ]} can_add_group={false} authenticity_token={authyToken} />);
