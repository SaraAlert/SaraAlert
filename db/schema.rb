...
ActiveRecord::Schema.define(version: 2022_03_10_154025) do
  ...
  create_table "api_downloads", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "common_exposure_cohorts", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "patient_id"
