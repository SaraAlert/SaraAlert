...
const requiredStrings = ['PRIMARY TELEPHONE NUMBER', 'SECONDARY TELEPHONE NUMBER', 'PRIMARY PHONE TYPE', 'SECONDARY PHONE TYPE', 'E-MAIL ADDRESS', 'CONFIRM E-MAIL ADDRESS'];
