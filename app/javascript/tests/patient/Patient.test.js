...
describe('Patient', () => {
  it('Properly renders all main components when not in edit mode', () => {
    const wrapper = shallow(<Patient details={mockPatient1} collapse={true} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
    expect(wrapper.find('#monitoree-details-header').exists()).toBeTruthy();
    expect(wrapper.find('#monitoree-details-header').at(0).find('span').at(1).text()).toContain(nameFormatter(mockPatient1));
  ...
  it('Properly renders all main components when in edit mode', () => {
    const wrapper = shallow(<Patient details={mockPatient4} goto={goToMock} collapse={true} edit_mode={true} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
    expect(wrapper.find('#monitoree-details-header').exists()).toBeTruthy();
    expect(wrapper.find('#monitoree-details-header').at(0).find('span').at(1).text()).toContain(nameFormatter(mockPatient4));
  ...
  it('Properly renders identification section', () => {
    ...
    expect(section.find('h3').text()).toEqual('Identification');
  ...
  it('Properly renders identification section when patient is a minor', () => {
    const wrapper = shallow(<Patient details={mockPatient5} hoh={mockPatient1} collapse={true} edit_mode={false} jurisdiction_paths={mockJurisdictionPaths} priority={1} />);
    const section = wrapper.find('#identification');
    expect(section.find('h3').text()).toEqual('Identification');
    expect(section.find('.edit-link').exists()).toBeTruthy();
    identificationFields.forEach((field, index) => {
  ...
  it('Properly renders contact information section', () => {
    ...
    expect(section.find('h3').text()).toEqual('Contact Information');
    expect(section.find('.edit-link').exists()).toBeTruthy();
  ...
  it('Properly renders contact information section if SMS is blocked', () => {
    const wrapper = shallow(<Patient details={{ ...mockPatient2, blocked_sms: true }} collapse={true} edit_mode={false} jurisdiction_paths={mockJurisdictionPaths} priority={1} />);
    const section = wrapper.find('#contact-information');
  ...
  it('Properly renders show/hide divider when props.collapse is false', () => {
    const wrapper = shallow(<Patient details={mockPatient1} collapse={false} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
    expect(wrapper.find('.details-expander').exists()).toBeTruthy();
    expect(wrapper.find('#details-expander-link').exists()).toBeTruthy();
    expect(wrapper.find('.details-expander').find(FontAwesomeIcon).exists()).toBeTruthy();
  ...
  it('Properly renders address section for domestic address with no monitoring address', () => {
    const wrapper = shallow(<Patient details={mockPatient2} collapse={true} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
    const section = wrapper.find('#address');
    expect(section.find('h3').text()).toEqual('Address');
    expect(section.find('.edit-link').exists()).toBeTruthy();
  ...
  it('Properly renders address section for foreign address with no monitoring address', () => {
    const wrapper = shallow(<Patient details={mockPatient5} collapse={true} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
    const section = wrapper.find('#address');
    expect(section.find('h3').text()).toEqual('Address');
    expect(section.find('.edit-link').exists()).toBeTruthy();
  ...
  it('Properly renders address section for foreign address and monitoring address', () => {
    const wrapper = shallow(<Patient details={mockPatient4} collapse={true} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
    const section = wrapper.find('#address');
    expect(section.find('h3').text()).toEqual('Address');
    expect(section.find('.edit-link').exists()).toBeTruthy();
  ...
  it('Properly renders arrival information section', () => {
    ...
    expect(section.find('h3').text()).toEqual('Arrival Information');
    expect(section.find('.edit-link').exists()).toBeTruthy();
  ...
  it('Collapses/expands travel related notes if longer than 400 characters', () => {
    const wrapper = shallow(<Patient details={mockPatient3} collapse={true} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
  ...
  it('Displays "None" if arrival information has no information', () => {
    const wrapper = shallow(<Patient details={blankMockPatient} collapse={true} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
    const section = wrapper.find('#arrival-information');
  ...
  it('Properly renders planned travel section', () => {
    ...
    expect(section.find('h3').text()).toEqual('Additional Planned Travel');
    expect(section.find('.edit-link').exists()).toBeTruthy();
  ...
  it('Properly renders potential exposure information section', () => {
    ...
    expect(section.find('h3').text()).toEqual('Potential Exposure Information');
    expect(section.find('.edit-link').exists()).toBeTruthy();
  ...
  it('Properly renders notes in potential exposure information section if the rest of the section is empty', () => {
    ...
    const wrapper = shallow(<Patient details={newMockPatient5} collapse={true} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
    const section = wrapper.find('#potential-exposure-information');
  ...
  it('Properly renders case information section', () => {
    ...
    expect(section.find('h3').text()).toEqual('Case Information');
    expect(section.find('.edit-link').exists()).toBeTruthy();
  ...
  it('Properly renders notes section', () => {
    ...
    expect(section.find('h3').text()).toEqual('Notes');
    expect(section.find('.none-text').exists()).toBeFalsy();
  ...
  it('Properly renders no details message', () => {
    const blankWrapper = shallow(<Patient details={null} workflow="global" priority={1} />);
    expect(blankWrapper.text()).toEqual('No monitoree details to show.');
  });

  it('Renders edit buttons if props.goto is defined', () => {
    const wrapper = shallow(<Patient details={mockPatient1} goto={goToMock} collapse={true} edit_mode={true} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
  ...
  it('Renders edit hrefs if props.goto is not defined', () => {
    ...
    const wrapper = shallow(<Patient details={mockPatient1} collapse={true} edit_mode={true} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
  ...
  it('Displays the Follow up Flag panel when a monitoree has a follow up flag set', () => {
    const wrapper = shallow(<Patient details={mockPatient3} goto={goToMock} collapse={true} edit_mode={false} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="global" priority={1} />);
