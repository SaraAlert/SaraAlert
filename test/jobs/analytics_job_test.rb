...
class AnalyticsJobTest < ActiveSupport::TestCase
  ...
  test 'cache analytics job' do
    ...
    assert_equal(7, MonitoreeCount.where(category_type: 'Risk Factor').size)
  ...
  test 'monitoree counts by age group' do
    ...
    verify_monitoree_count(active_counts, 2, true, 'Age Group', '100-109', 1)
    verify_monitoree_count(active_counts, 3, true, 'Age Group', '20-29', 3)
    verify_monitoree_count(active_counts, 4, true, 'Age Group', '20-29', 1)
    verify_monitoree_count(active_counts, 5, true, 'Age Group', '30-39', 3)
    verify_monitoree_count(active_counts, 6, true, 'Age Group', '30-39', 2)
    verify_monitoree_count(active_counts, 7, true, 'Age Group', '40-49', 10)
