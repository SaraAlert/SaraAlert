...
describe('MonitoringStatus', () => {
  ...
  it('Properly renders radio buttons for updating dependents LDE', () => {
    ...
    expect(wrapper.find('#apply_to_household_cm_exp_only_no').at(0).prop('type')).toEqual('radio');
    expect(wrapper.find('#apply_to_household_cm_exp_only_no').at(0).prop('label')).toEqual('No, household members still have continuous exposure to another case');
    expect(wrapper.find('#apply_to_household_cm_exp_only_no').at(0).prop('checked')).toBeTruthy();
    expect(wrapper.find('#apply_to_household_cm_exp_only_yes').at(0).prop('type')).toEqual('radio');
