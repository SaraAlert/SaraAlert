...
class MonitoreeEnrollmentSteps < ApplicationSystemTestCase
  def steps
    {
      identification: [
        ...
        { id: 'primary_language', type: 'text', required: false, info_page: true },
        { id: 'secondary_language', type: 'text', required: false, info_page: false },
