...
Duplicate detection can be enabled to prevent duplicate creations, simply include the `If-None-Exist` header containing the search parameters. An example of this could be: `state-local-id=EX-286392&birthdate=1966-12-01`
...
* `request.ifNoneExist` - If present, will be the search parameters used for duplicate detection, for example: `state-local-id=EX-286392&birthdate=1966-12-01`
