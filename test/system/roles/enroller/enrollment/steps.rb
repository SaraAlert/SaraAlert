  ...
  def steps
    {
      identification: [
        ...
        { id: 'race_unknown', type: 'race', required: false, info_page: 'Unknown', label: 'UNKNOWN' },
        { id: 'race_other', type: 'race', required: false, info_page: 'Other', label: 'OTHER' },
        { id: 'race_refused_to_answer', type: 'race', required: false, info_page: 'Refused to Answer', label: 'REFUSED TO ANSWER' },
      ...
      potential_exposure_info: [
        ...
        { id: 'was_in_health_care_facility_with_known_cases', type: 'risk_factor', required: false, info_page: true, label: 'WAS IN HEALTH CARE FACILITY WITH KNOWN CASES' },
