...
class AnalyticsTaskTest < ActiveSupport::TestCase
  ...
  test "monitoree counts by exposure country" do
    ...
    verify_monitoree_count(active_counts[0], true, 'Exposure Country', 'Faroe Islands', 'High', 1)
    verify_monitoree_count(active_counts[1], true, 'Exposure Country', 'Faroe Islands', 'No Identified Risk', 1)
    verify_monitoree_count(active_counts[2], true, 'Exposure Country', 'Iceland', 'High', 1)
    verify_monitoree_count(active_counts[3], true, 'Exposure Country', 'Korea', 'Medium', 1)
    verify_monitoree_count(active_counts[4], true, 'Exposure Country', 'Malaysia', 'High', 1)
    verify_monitoree_count(active_counts[5], true, 'Exposure Country', 'Malaysia', 'Medium', 1)
    verify_monitoree_count(active_counts[6], true, 'Exposure Country', 'Malaysia', 'Missing', 1)
    verify_monitoree_count(active_counts[7], true, 'Exposure Country', 'United States Minor Outlying Islands', 'Missing', 1)
    verify_monitoree_count(active_counts[8], true, 'Exposure Country', 'Total', 'High', 3)
    verify_monitoree_count(active_counts[9], true, 'Exposure Country', 'Total', 'Medium', 2)
    verify_monitoree_count(active_counts[10], true, 'Exposure Country', 'Total', 'No Identified Risk', 2)
    verify_monitoree_count(active_counts[11], true, 'Exposure Country', 'Total', 'Missing', 2)
    assert_equal(12, active_counts.length)
    overall_counts = monitoree_counts_by_exposure_country(@@monitorees, false)
    verify_monitoree_count(overall_counts[0], false, 'Exposure Country', 'China', 'No Identified Risk', 1)
    verify_monitoree_count(overall_counts[1], false, 'Exposure Country', 'Faroe Islands', 'High', 1)
    verify_monitoree_count(overall_counts[2], false, 'Exposure Country', 'Faroe Islands', 'No Identified Risk', 1)
    verify_monitoree_count(overall_counts[3], false, 'Exposure Country', 'Iceland', 'High', 1)
    verify_monitoree_count(overall_counts[4], false, 'Exposure Country', 'Malaysia', 'High', 1)
    verify_monitoree_count(overall_counts[5], false, 'Exposure Country', 'Malaysia', 'Low', 1)
    verify_monitoree_count(overall_counts[6], false, 'Exposure Country', 'Malaysia', 'Medium', 1)
    verify_monitoree_count(overall_counts[7], false, 'Exposure Country', 'Malaysia', 'Missing', 1)
    verify_monitoree_count(overall_counts[8], false, 'Exposure Country', 'United States Minor Outlying Islands', 'Missing', 1)
    verify_monitoree_count(overall_counts[9], false, 'Exposure Country', 'Total', 'High', 3)
    verify_monitoree_count(overall_counts[10], false, 'Exposure Country', 'Total', 'Low', 2)
    verify_monitoree_count(overall_counts[11], false, 'Exposure Country', 'Total', 'Medium', 2)
    verify_monitoree_count(overall_counts[12], false, 'Exposure Country', 'Total', 'No Identified Risk', 2)
    verify_monitoree_count(overall_counts[13], false, 'Exposure Country', 'Total', 'Missing', 2)
