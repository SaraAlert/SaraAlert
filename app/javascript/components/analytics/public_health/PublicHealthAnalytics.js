...
class PublicHealthAnalytics extends React.Component {
  ...
  toggleGraphs = showGraphs => this.setState({ showGraphs });
    ...
    if (this.state.hasErrors) {
      ...
      return (
        <React.Fragment>
          <h1 className="sr-only">Analytics</h1>
          <Row className="mx-2">
            <Col className="align-self-center mb-2 p-0">
            ...
            <Col sm="24" md="auto" className="text-right mb-2 p-0">
          ...
          <Row className="mx-2">
            <Col className="mx-0 my-3 p-0">
              <Demographics stats={this.props.stats} showGraphs={this.state.showGraphs} />
            </Col>
          </Row>
          <Row className="mx-2">
            <Col className="mx-0 my-3 p-0">
              <ExposureSummary stats={this.props.stats} showGraphs={this.state.showGraphs} />
            </Col>
          </Row>
          <Row className="mx-2">
            <Col className="mx-0 my-3 p-0">
