...
Sidekiq.configure_server do |config|
  ...
  Sidekiq::Status.configure_server_middleware config, expiration: Rails.configuration.api['bulk_export_expiration_minutes'].minutes
  Sidekiq::Status.configure_client_middleware config, expiration: Rails.configuration.api['bulk_export_expiration_minutes'].minutes
end
