        ...
        <Card className="mx-0 card-square align-item-center">
          ...
          <Card.Body>
            ...
            <Form.Row className="pt-5">
              <Button variant="primary" id="submit_button" block size="lg" className="btn-block btn-square" disabled={!(this.state.current.experiencing_symptoms && this.state.current.temperature)} onClick={this.navigate}>{this.state.current.experiencing_symptoms === "Yes" && "Continue" || this.state.current.experiencing_symptoms !== "Yes" && "Submit"}</Button>
            </Form.Row>
         </Card.Body>
        </Card>
      </React.Fragment>
