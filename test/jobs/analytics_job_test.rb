...
class AnalyticsJobTest < ActiveSupport::TestCase
  ...
  test 'monitoree counts by total' do
    ...
    verify_monitoree_count(active_counts, 0, true, 'Overall Total', 'Total', 'Missing', 28)
    ...
    verify_monitoree_count(overall_counts, 0, false, 'Overall Total', 'Total', 'Missing', 28)
  ...
  test 'monitoree counts by monitoring status' do
    ...
    verify_monitoree_count(active_counts, 1, true, 'Monitoring Status', 'Non-Reporting', 'Missing', 23)
  ...
  test 'monitoree counts by age group' do
    ...
    verify_monitoree_count(active_counts, 8, true, 'Age Group', '40-49', 'Missing', 13)
    ...
    verify_monitoree_count(overall_counts, 9, false, 'Age Group', '40-49', 'Missing', 13)
  ...
  test 'monitoree counts by sex' do
    ...
    verify_monitoree_count(active_counts, 2, true, 'Sex', 'Female', 'Missing', 12)
    ...
    verify_monitoree_count(active_counts, 7, true, 'Sex', 'Male', 'Missing', 14)
    ...
    verify_monitoree_count(overall_counts, 2, false, 'Sex', 'Female', 'Missing', 12)
    ...
    verify_monitoree_count(overall_counts, 7, false, 'Sex', 'Male', 'Missing', 14)
  ...
  test 'monitoree counts by last exposure date' do
    ...
    verify_monitoree_count(active_counts, 10, true, 'Last Exposure Date', days_ago(5), 'Missing', 12)
    ...
    verify_monitoree_count(overall_counts, 10, false, 'Last Exposure Date', days_ago(5), 'Missing', 12)
  ...
  test 'monitoree snapshots' do
    ...
    verify_snapshot(snapshots, 2, 'Total', 44, 0, 3, 0)
    ...
    verify_snapshot(snapshots, 2, 'Total', 26, 2, 1, 2)
  end
