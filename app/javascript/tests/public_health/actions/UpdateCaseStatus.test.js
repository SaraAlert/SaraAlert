...
function getMountedWrapper(patientsArray) {
  let instance = mount(<UpdateCaseStatus authenticity_token={mockToken} patients={patientsArray} monitoring_reasons={mockMonitoringReasons} close={onCloseMock} />);
...
describe('UpdateCaseStatus', () => {
  ...
  it('Properly does not display any follow-up options when the empty string is selected', () => {
    ...
    mountedWrapper
      .find('FormControl')
      .first()
      .simulate('change', { target: { id: 'case_status', type: 'change', value: option } });
  ...
  it('Properly sets the correct follow-up options for "Confirmed", and "Probable"', () => {
    ...
    ['Confirmed', 'Probable'].forEach(case_status_option => {
      mountedWrapper
        .find('FormControl')
        .first()
        .simulate('change', { target: { id: 'case_status', type: 'change', value: case_status_option } });
      ...
      mountedWrapper
        .find('FormControl')
        .at(1)
        .simulate('change', { target: { id: 'follow_up', type: 'change', value: 'End Monitoring' } });
      ...
      mountedWrapper
        .find('FormControl')
        .at(1)
        .simulate('change', { target: { id: 'follow_up', type: 'change', value: 'Continue Monitoring in Isolation Workflow' } });
