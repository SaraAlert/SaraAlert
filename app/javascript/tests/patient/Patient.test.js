...
describe('Patient', () => {
  ...
  it('Properly renders arrival information section', () => {
    ...
    expect(departedColumn.find('b').at(2).text()).toEqual('Carrier:');
    expect(departedColumn.find('span').at(2).text()).toEqual(mockPatient1.flight_or_vessel_carrier);
    expect(departedColumn.find('b').at(3).text()).toEqual('Flight or Vessel #:');
    expect(departedColumn.find('span').at(3).text()).toEqual(mockPatient1.flight_or_vessel_number);
