...
Duplicate detection can be enabled to prevent duplicate creattions, simply include the `If-None-Exist` header containing the search parameters. An example of this could be: `state-local-id=EX-286392birthDate=1966-12-01`
