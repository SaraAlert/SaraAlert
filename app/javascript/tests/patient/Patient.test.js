...
describe('Patient', () => {
  ...
  it('Renders edit buttons if props.goto is defined in exposure', () => {
    const wrapper = shallow(<Patient details={mockPatient2} goto={goToMock} collapse={true} edit_mode={true} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="exposure" />);
  ...
  it('Renders edit buttons if props.goto is defined in isolation', () => {
    const wrapper = shallow(<Patient details={mockPatient1} goto={goToMock} collapse={true} edit_mode={true} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="isolation" />);
  ...
  it('Renders edit hrefs if props.goto is not defined in exposure', () => {
    ...
    const wrapper = shallow(<Patient details={mockPatient2} collapse={true} edit_mode={true} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="exposure" />);
  ...
  it('Renders edit hrefs if props.goto is not defined in isolation', () => {
    ...
    const wrapper = shallow(<Patient details={mockPatient1} collapse={true} edit_mode={true} current_user={mockUser1} jurisdiction_paths={mockJurisdictionPaths} other_household_members={[]} can_modify_subject_status={true} workflow="isolation" />);
    expect(wrapper.find('.edit-link').find(Button).exists()).toBeFalsy();
