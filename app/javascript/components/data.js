...
export const stateOptions = [
  { name: 'Alabama', abbrv: 'AL', mapFile: 'alLow' },
  { name: 'Alaska', abbrv: 'AK', mapFile: 'akLow' },
  { name: 'American Samoa', abbrv: 'AS', mapFile: 'RANDOMSQUARE' },
  { name: 'Arizona', abbrv: 'AZ', mapFile: 'azLow' },
  { name: 'Arkansas', abbrv: 'AR', mapFile: 'arLow' },
  { name: 'California', abbrv: 'CA', mapFile: 'caLow' },
  { name: 'Colorado', abbrv: 'CO', mapFile: 'coLow' },
  { name: 'Connecticut', abbrv: 'CT', mapFile: 'ctLow' },
  { name: 'Delaware', abbrv: 'DE', mapFile: 'deLow' },
  { name: 'District of Columbia', abbrv: 'DC', mapFile: 'dcLow' },
  { name: 'Federated States of Micronesia', abbrv: 'FM', mapFile: 'RANDOMSQUARE' },
  { name: 'Florida', abbrv: 'FL', mapFile: 'flLow' },
  { name: 'Georgia', abbrv: 'GA', mapFile: 'gaLow' },
  { name: 'Guam', abbrv: 'GU', mapFile: 'RANDOMSQUARE' },
  { name: 'Hawaii', abbrv: 'HI', mapFile: 'hiLow' },
  { name: 'Idaho', abbrv: 'ID', mapFile: 'idLow' },
  { name: 'Illinois', abbrv: 'IL', mapFile: 'ilLow' },
  { name: 'Indiana', abbrv: 'IN', mapFile: 'inLow' },
  { name: 'Iowa', abbrv: 'IA', mapFile: 'iaLow' },
  { name: 'Kansas', abbrv: 'KS', mapFile: 'ksLow' },
  { name: 'Kentucky', abbrv: 'KY', mapFile: 'kyLow' },
  { name: 'Louisiana', abbrv: 'LA', mapFile: 'laLow' },
  { name: 'Maine', abbrv: 'ME', mapFile: 'meLow' },
  { name: 'Marshall Islands', abbrv: 'MH', mapFile: 'RANDOMSQUARE' },
  { name: 'Maryland', abbrv: 'MD', mapFile: 'mdLow' },
  { name: 'Massachusetts', abbrv: 'MA', mapFile: 'maLow' },
  { name: 'Michigan', abbrv: 'MI', mapFile: 'miLow' },
  { name: 'Minnesota', abbrv: 'MN', mapFile: 'mnLow' },
  { name: 'Mississippi', abbrv: 'MS', mapFile: 'msLow' },
  { name: 'Missouri', abbrv: 'MO', mapFile: 'moLow' },
  { name: 'Montana', abbrv: 'MT', mapFile: 'mtLow' },
  { name: 'Nebraska', abbrv: 'NE', mapFile: 'neLow' },
  { name: 'Nevada', abbrv: 'NV', mapFile: 'nvLow' },
  { name: 'New Hampshire', abbrv: 'NH', mapFile: 'nhLow' },
  { name: 'New Jersey', abbrv: 'NJ', mapFile: 'njLow' },
  { name: 'New Mexico', abbrv: 'NM', mapFile: 'nmLow' },
  { name: 'New York', abbrv: 'NY', mapFile: 'nyLow' },
  { name: 'North Carolina', abbrv: 'NC', mapFile: 'ncLow' },
  { name: 'North Dakota', abbrv: 'ND', mapFile: 'ndLow' },
  ...
  { name: 'South Carolina', abbrv: 'SC', mapFile: 'scLow' },
  { name: 'South Dakota', abbrv: 'SD', mapFile: 'sdLow' },
  { name: 'Tennessee', abbrv: 'TN', mapFile: 'tnLow' },
  { name: 'Texas', abbrv: 'TX', mapFile: 'txLow' },
  { name: 'Utah', abbrv: 'UT', mapFile: 'utLow' },
  { name: 'Vermont', abbrv: 'VT', mapFile: 'vtLow' },
  { name: 'Virgin Islands', abbrv: 'VI', mapFile: 'RANDOMSQUARE' },
  { name: 'Virginia', abbrv: 'VA', mapFile: 'vaLow' },
  { name: 'Washington', abbrv: 'WA', mapFile: 'waLow' },
  { name: 'West Virginia', abbrv: 'WV', mapFile: 'wvLow' },
  { name: 'Wisconsin', abbrv: 'WI', mapFile: 'wiLow' },
  { name: 'Wyoming', abbrv: 'WY', mapFile: 'wyLow' },
];
