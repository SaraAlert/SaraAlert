...
class DownloadMonitoreeExcel extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        <Button id="monitoree-excel-export" className="ml-2 mb-3" onClick={this.downloadExcel} disabled={this.state.loadingExcel}>
        ...
        <Button id="monitoree-nbs-export" className="mx-2 mb-3" onClick={this.downloadNBS} disabled={this.state.loadingNBS}>
