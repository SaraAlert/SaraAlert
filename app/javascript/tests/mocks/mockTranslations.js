  ...
  eng: {
    ...
    email: {
      ...
      enrollment: {
        ...
        info2:
          'You will receive a similar reminder daily until your monitoring period has ended. If you have any questions please reach out to the public health organization that helped enroll you.',
        report: 'Daily Report',
        footer:
          'Do not reply to this email, forward this email, or share this link. This message was automatically generated by the Sara Alert system and is unique and intended only for you. If you wish to stop receiving these notifications or believe that it was a mistake, please contact your local public health department. For privacy and more info, visit saraalert.org.',
      },
  ...
  spa: {
    ...
    email: {
      ...
      enrollment: {
        ...
        info2:
          'Usted recibirá un recordatorio diario similar hasta que finalice su período de monitoreo. Si tiene alguna pregunta, por favor pónganse en contacto con el proveedor de atención médica que le ayudó a inscribirse.',
        report: 'Reporte diario',
        footer:
          'No responda o reenvíe este correo electrónico, ni comparta este enlace. Este mensaje fue generado automáticamente por el sistema Sara Alert y es único y está destinado solo para usted. Si desea dejar de recibir estas notificaciones o piensa que fue un error, por favor pónganse en contacto con su departamento de salud pública local. Para privacidad y más información, visite saraalert.org.',
      },
  ...
  fra: {
    ...
    email: {
      ...
      enrollment: {
        ...
        info2:
          'Vous recevrez un rappel similaire tous les jours jusqu’à ce que votre période de surveillance soit terminée. Si vous avez des questions, veuillez contacter le professionnel de santé qui vous a recruté(e).',
  ...
  som: {
    ...
    email: {
      ...
      enrollment: {
        ...
        info2:
          'Waxaad heli doontaa xusuusin la mid ah maalin kasta ilaa muddada la socoshadaada ka dhammaato. Haddii aad qabtid wax su’aalo ah, fadlan la xiriir xirfadlaha daryeelka caafimaadka kaasoo kaa caawiyay in lagu diiwaangeliyo.',
