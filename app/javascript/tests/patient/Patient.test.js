...
describe('Patient', () => {
  ...
  it('Properly renders show/hide divider when expanded is false', () => {
    const wrapper = shallow(<Patient details={mockPatient1} goto={goToMock} edit_mode={false} jurisdiction_path='USA, State 1, County 2' />);
    expect(wrapper.find('.details-expander').exists()).toBeTruthy();
  ...
  it('Properly renders no details message', () => {
    const blankWrapper = shallow(<Patient details={null} jurisdiction_path='USA, State 1, County 2' />);
    expect(blankWrapper.text()).toEqual('No monitoree details to show.');
  });

  it('Renders edit buttons if props.goto is defined', () => {
    const wrapper = shallow(<Patient details={mockPatient1} goto={goToMock} edit_mode={true} jurisdiction_path='USA, State 1, County 2' />);
  ...
  it('Renders edit hrefs if props.goto is not defined', () => {
    ...
    const wrapper = shallow(<Patient details={mockPatient1} edit_mode={true} jurisdiction_path='USA, State 1, County 2' />);
