...
class History < ApplicationRecord
  ...
  def self.assessment_email_error(patient: nil,
                                  ...
                                  comment: 'Sara Alert was unable to send a report email to the monitoree because of a network issue unrelated to Sara Alert.')
    create_history(patient, created_by, HISTORY_TYPES[:assessment_email_error], comment)
  end
