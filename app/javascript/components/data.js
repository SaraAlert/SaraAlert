...
export const stateOptions = [
  { abbrv: 'AL', isoCode: 'US-AL', mapFile: 'alLow', name: 'Alabama' },
  { abbrv: 'AK', isoCode: 'US-AK', mapFile: 'akLow', name: 'Alaska' },
  { abbrv: 'AS', isoCode: 'US-AS', mapFile: 'usaTerritories', name: 'American Samoa' },
  { abbrv: 'AZ', isoCode: 'US-AZ', mapFile: 'azLow', name: 'Arizona' },
  { abbrv: 'AR', isoCode: 'US-AR', mapFile: 'arLow', name: 'Arkansas' },
  { abbrv: 'CA', isoCode: 'US-CA', mapFile: 'caLow', name: 'California' },
  { abbrv: 'CO', isoCode: 'US-CO', mapFile: 'coLow', name: 'Colorado' },
  { abbrv: 'CT', isoCode: 'US-CT', mapFile: 'ctLow', name: 'Connecticut' },
  { abbrv: 'DE', isoCode: 'US-DE', mapFile: 'deLow', name: 'Delaware' },
  { abbrv: 'DC', isoCode: 'US-DC', mapFile: 'dcLow', name: 'District of Columbia' },
  { abbrv: 'FM', isoCode: 'US-FM', mapFile: 'usaTerritories', name: 'Federated States of Micronesia' },
  { abbrv: 'FL', isoCode: 'US-FL', mapFile: 'flLow', name: 'Florida' },
  { abbrv: 'GA', isoCode: 'US-GA', mapFile: 'gaLow', name: 'Georgia' },
  { abbrv: 'GU', isoCode: 'US-GU', mapFile: 'usaTerritories', name: 'Guam' },
  { abbrv: 'HI', isoCode: 'US-HI', mapFile: 'hiLow', name: 'Hawaii' },
  { abbrv: 'ID', isoCode: 'US-ID', mapFile: 'idLow', name: 'Idaho' },
  { abbrv: 'IL', isoCode: 'US-IL', mapFile: 'ilLow', name: 'Illinois' },
  { abbrv: 'IN', isoCode: 'US-IN', mapFile: 'inLow', name: 'Indiana' },
  { abbrv: 'IA', isoCode: 'US-IA', mapFile: 'iaLow', name: 'Iowa' },
  { abbrv: 'KS', isoCode: 'US-KS', mapFile: 'ksLow', name: 'Kansas' },
  ...
  { abbrv: 'MN', isoCode: 'US-MN', mapFile: 'mnLow', name: 'Minnesota' },
  { abbrv: 'MS', isoCode: 'US-MS', mapFile: 'msLow', name: 'Mississippi' },
  { abbrv: 'MO', isoCode: 'US-MO', mapFile: 'moLow', name: 'Missouri' },
  { abbrv: 'MT', isoCode: 'US-MT', mapFile: 'mtLow', name: 'Montana' },
  { abbrv: 'NE', isoCode: 'US-NE', mapFile: 'neLow', name: 'Nebraska' },
  { abbrv: 'NV', isoCode: 'US-NV', mapFile: 'nvLow', name: 'Nevada' },
  { abbrv: 'NH', isoCode: 'US-NH', mapFile: 'nhLow', name: 'New Hampshire' },
  { abbrv: 'NJ', isoCode: 'US-NJ', mapFile: 'njLow', name: 'New Jersey' },
  { abbrv: 'NM', isoCode: 'US-NM', mapFile: 'nmLow', name: 'New Mexico' },
  { abbrv: 'NY', isoCode: 'US-NY', mapFile: 'nyLow', name: 'New York' },
  { abbrv: 'NC', isoCode: 'US-NC', mapFile: 'ncLow', name: 'North Carolina' },
  { abbrv: 'ND', isoCode: 'US-ND', mapFile: 'ndLow', name: 'North Dakota' },
  ...
  { abbrv: 'SC', isoCode: 'US-SC', mapFile: 'scLow', name: 'South Carolina' },
  { abbrv: 'SD', isoCode: 'US-SD', mapFile: 'sdLow', name: 'South Dakota' },
  { abbrv: 'TN', isoCode: 'US-TN', mapFile: 'tnLow', name: 'Tennessee' },
  { abbrv: 'TX', isoCode: 'US-TX', mapFile: 'txLow', name: 'Texas' },
  { abbrv: 'UT', isoCode: 'US-UT', mapFile: 'utLow', name: 'Utah' },
  { abbrv: 'VT', isoCode: 'US-VT', mapFile: 'vtLow', name: 'Vermont' },
  { abbrv: 'VI', isoCode: 'US-VI', mapFile: 'usaTerritories', name: 'Virgin Islands' },
  { abbrv: 'VA', isoCode: 'US-VA', mapFile: 'vaLow', name: 'Virginia' },
  { abbrv: 'WA', isoCode: 'US-WA', mapFile: 'waLow', name: 'Washington' },
  { abbrv: 'WV', isoCode: 'US-WV', mapFile: 'wvLow', name: 'West Virginia' },
  { abbrv: 'WI', isoCode: 'US-WI', mapFile: 'wiLow', name: 'Wisconsin' },
