...
module ImportExportConstants # rubocop:todo Metrics/ModuleLength
  ...
  SARA_ALERT_FORMAT_FIELDS = %i[first_name middle_name last_name date_of_birth sex white black_or_african_american american_indian_or_alaska_native asian
                                ...
                                vaccine_2_notes vaccine_3_group_name vaccine_3_product_name vaccine_3_administration_date vaccine_3_dose_number vaccine_3_notes
                                follow_up_reason follow_up_note].freeze
  ...
  SARA_ALERT_FORMAT_HEADERS = ['First Name', 'Middle Name', 'Last Name', 'Date of Birth', 'Sex at Birth', 'White', 'Black or African American',
                               ...
                               'Vaccine 2 Dose Number', 'Vaccine 2 Notes', 'Vaccine 3 Group Name', 'Vaccine 3 Product Name', 'Vaccine 3 Administration Date',
                               'Vaccine 3 Dose Number', 'Vaccine 3 Notes', 'Follow-Up Reason', 'Follow-Up Note'].freeze
