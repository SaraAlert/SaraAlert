...
class PublicHealthMonitoringImportVerifier < ApplicationSystemTestCase
  ...
  BOOL_FIELDS = %i[interpretation_required contact_of_known_case travel_to_affected_country_or_area was_in_health_care_facility_with_known_cases 
                  laboratory_personnel healthcare_personnel crew_on_passenger_or_cargo_flight member_of_a_common_exposure_cohort].freeze
  RACE_FIELDS = %i[races].freeze
