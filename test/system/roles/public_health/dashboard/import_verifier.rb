...
class PublicHealthMonitoringImportVerifier < ApplicationSystemTestCase
  ...
  BOOL_FIELDS = %i[white black_or_african_american american_indian_or_alaska_native asian native_hawaiian_or_other_pacific_islander race_unknown
                   race_other race_refused_to_answer interpretation_required contact_of_known_case travel_to_affected_country_or_area
