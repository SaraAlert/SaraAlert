...
class PurgeJobTest < ActiveSupport::TestCase
  ...
  test 'nils out everything but kept attributes' do
    patient = create(:patient, monitoring: false, purged: false, continuous_exposure: false, submission_token: 'a',
                               ...
                               travel_to_affected_country_or_area: false, laboratory_personnel: false, laboratory_personnel_facility_name: 'a',
                               healthcare_personnel: false, healthcare_personnel_facility_name: 'a', crew_on_passenger_or_cargo_flight: false,
