...
class MonitoreeAssessmentForm < ApplicationSystemTestCase
  @@monitoree_assessment_form_verifier = MonitoreeAssessmentFormVerifier.new(nil)
  ...
  def complete_assessment(patient, assessment_label)
    ...
    @@monitoree_assessment_form_verifier.verify_assessment(patient, ASSESSMENTS[assessment_label])
  end
