...
describe('EnrollerStatistics', () => {
  it('Properly Renders All Values and Headers correctly', () => {
    const esWrapper = shallow(<EnrollerStatistics title={componentProps.title} total_monitorees={componentProps.total_monitorees} new_monitorees={componentProps.new_monitorees} total_reports={componentProps.total_reports} new_reports={componentProps.new_reports} />);
