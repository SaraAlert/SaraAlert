...
class AnalyticsTaskTest < ActiveSupport::TestCase
  ...
  test "monitoree counts by sex" do
    ...
    verify_monitoree_count(active_counts[7], true, 'Sex', 'Male', 'Medium', 2)
    verify_monitoree_count(active_counts[8], true, 'Sex', 'Male', 'No Identified Risk', 2)
    ...
    verify_monitoree_count(overall_counts[7], false, 'Sex', 'Male', 'Medium', 2)
    verify_monitoree_count(overall_counts[8], false, 'Sex', 'Male', 'No Identified Risk', 2)
